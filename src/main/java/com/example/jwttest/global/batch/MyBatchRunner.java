...
public class MyBatchRunner implements CommandLineRunner {
    ...
    public void runJob() throws Exception {
        ...
        ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDateTime.of(LocalDate.now(), LocalTime.of(3,LocalTime.now().getMinute(),LocalTime.now().getSecond())), ZoneId.of("Asia/Seoul"));
